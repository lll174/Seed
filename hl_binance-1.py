...
class Live:
    ...
    async def run_daily(self) -> None:
        ...
        Läuft in einem Hintergrund-Thread mit EIGENER Datenbankverbindung --
        SQLite erlaubt keine Verbindung über Thread-Grenzen hinweg.
        """
        ...
        def job():
            ...
            try:
                backfill_daily(con, list(self.coin2sym) + self.extra_coins, 5, self.coin2sym)
            finally:
                con.close()
